...
class UsuariosForm(forms.ModelForm):
	...
	email = forms.CharField(required=False,max_length=50,label='Email (Participa en nuestro concurso)', help_text='Envíanos tu mail si quieres participar en el sorteo de material Fenix!')
