...
class UsuariosForm(forms.ModelForm):
	...
	email = forms.CharField(required=False,max_length=10,label='Email (Particia en nuestro sorteo)', help_text='Envíanos tu mail si quieres participar en el sorteo de material Fenix.!')
